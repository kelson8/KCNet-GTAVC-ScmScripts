...
interiors_inner:
	...
	++ pooz_counter
		...
		IF IS_PLAYER_PLAYING player
			flag_interiors_cleanup = 0
			IF pooz_counter = 1
				IF IS_PLAYER_IN_ZONE player BEACH1
					...
					IF flag_membership = 1 
						...
						IF IS_PLAYER_PLAYING player
							...
							AND flag_player_on_mission = 0
								IF IS_PLAYER_IN_REMOTE_MODE player
									GET_REMOTE_CONTROLLED_CAR player player_car_interiors
									...
									ENDIF
								ELSE
									IF LOCATE_PLAYER_ANY_MEANS_3D player 95.3 -1468.3 9.5 1.5 1.5 3.0 FALSE

										IF IS_PLAYER_IN_ANY_CAR player
										AND NOT IS_PLAYER_ON_ANY_BIKE player
										AND NOT IS_PLAYER_IN_MODEL player CADDY
										...
										GOSUB transition_1
										IF IS_PLAYER_PLAYING player
											IF IS_PLAYER_ON_ANY_BIKE player
											OR IS_PLAYER_IN_MODEL player CADDY
												STORE_CAR_PLAYER_IS_IN_NO_SAVE player player_car_interiors
												WARP_PLAYER_FROM_CAR_TO_COORD player 91.2 -1460.9 10.0
										...
										IF flag_eject = 0
											...
											SET_PLAYER_COORDINATES player 91.2 -1460.9 10.0
											SET_PLAYER_HEADING player 40.0
							...
							IF flag_player_in_stripclub = 1
								IF LOCATE_PLAYER_ANY_MEANS_3D	player 92.23 -1463.1 9.5 1.5 1.5 3.0 FALSE
									IF IS_PLAYER_IN_ANY_CAR player
									//AND NOT IS_PLAYER_ON_ANY_BIKE player
										GOTO interiors_inner
									ENDIF
									...
									IF flag_eject = 0
										...
										SET_PLAYER_COORDINATES player 97.7  -1472.2 9.7
										SET_PLAYER_HEADING player 280.0
										SET_CAMERA_IN_FRONT_OF_PLAYER
										...
										IF IS_AUSTRALIAN_GAME
											...
											IF NOT weapon_strip = WEAPONTYPE_UNARMED
												...
												GOSUB aussie
												IF IS_PLAYER_PLAYING player
													GIVE_WEAPON_TO_PLAYER player jobby_1 ammo_slot_1
												ENDIF
												GOSUB aussie2
											ENDIF
											...
											IF NOT weapon_strip = WEAPONTYPE_UNARMED
												...
												GOSUB aussie
												IF IS_PLAYER_PLAYING player
													GIVE_WEAPON_TO_PLAYER player jobby_2 ammo_slot_2
												ENDIF
												GOSUB aussie2
											ENDIF
											...
											IF NOT weapon_strip = WEAPONTYPE_UNARMED
												...
												GOSUB aussie
												IF IS_PLAYER_PLAYING player
													GIVE_WEAPON_TO_PLAYER player jobby_3 ammo_slot_3
												ENDIF
												GOSUB aussie2
											ENDIF
											...
											IF NOT weapon_strip = WEAPONTYPE_UNARMED
												...
												GOSUB aussie
												IF IS_PLAYER_PLAYING player
													GIVE_WEAPON_TO_PLAYER player jobby_4 ammo_slot_4
												ENDIF
												GOSUB aussie2
											ENDIF
											...
											IF NOT weapon_strip = WEAPONTYPE_UNARMED
												...
												GOSUB aussie
												IF IS_PLAYER_PLAYING player
													GIVE_WEAPON_TO_PLAYER player jobby_5 ammo_slot_5
												ENDIF
												GOSUB aussie2
											ENDIF
											...
											IF NOT weapon_strip = WEAPONTYPE_UNARMED
												...
												GOSUB aussie
												IF IS_PLAYER_PLAYING player
													GIVE_WEAPON_TO_PLAYER player jobby_6 ammo_slot_6
												ENDIF
												GOSUB aussie2
											ENDIF
											...
											IF NOT weapon_strip = WEAPONTYPE_UNARMED
												...
												GOSUB aussie
												IF IS_PLAYER_PLAYING player
													GIVE_WEAPON_TO_PLAYER player jobby_7 ammo_slot_7
												ENDIF
												GOSUB aussie2
											ENDIF
											...
											IF NOT weapon_strip = WEAPONTYPE_UNARMED
												...
												GOSUB aussie
												IF IS_PLAYER_PLAYING player
													GIVE_WEAPON_TO_PLAYER player jobby_8 ammo_slot_8
												ENDIF
												GOSUB aussie2
											ENDIF
											...
											IF NOT weapon_strip = WEAPONTYPE_UNARMED
												...
												GOSUB aussie
												IF IS_PLAYER_PLAYING player
													GIVE_WEAPON_TO_PLAYER player jobby_9 ammo_slot_9
												ENDIF
												GOSUB aussie2
											ENDIF
										ENDIF
				...
				OR flag_player_on_rc_mission = 1
					IF flag_player_in_hotel = 0
						IF IS_PLAYER_IN_REMOTE_MODE player
							...
							ENDIF
						ELSE
							IF IS_PLAYER_IN_AREA_3D player 222.0 -1274.0 11.0 229.0 -1280.7 14.0 FALSE 
								IF IS_PLAYER_IN_ANY_CAR player
								AND NOT IS_PLAYER_ON_ANY_BIKE player
									GOTO interiors_inner
								ENDIF
								...
								IF IS_PLAYER_PLAYING player
									IF IS_PLAYER_ON_ANY_BIKE player
										STORE_CAR_PLAYER_IS_IN_NO_SAVE player player_car_interiors
										WARP_PLAYER_FROM_CAR_TO_COORD player 225.0 -1277.3 11.5
										DELETE_CAR player_car_interiors
									ENDIF
								ENDIF
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player 225.0 -1277.3 11.5
									SET_PLAYER_HEADING player 80.0
					...
					IF flag_player_in_hotel = 1
						IF IS_PLAYER_IN_AREA_3D player 235.0 -1274.0 11.0 227.5.0 -1280.7 16.0 FALSE
							IF IS_PLAYER_IN_ANY_CAR player
							AND NOT IS_PLAYER_ON_ANY_BIKE player
								GOTO interiors_inner
							ENDIF
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player 233.5  -1278.45 11.0
				...
				OR flag_player_on_rc_mission = 1
					IF flag_player_in_apartment3c = 0
						IF IS_PLAYER_IN_REMOTE_MODE player
							...
							ENDIF
						ELSE
							IF LOCATE_PLAYER_ANY_MEANS_3D	player 26.95 -1328.3 13.0 1.0 1.0 2.0 FALSE
								IF IS_PLAYER_PLAYING player
									IF IS_PLAYER_ON_ANY_BIKE player
									//OR IS_PLAYER_IN_MODEL player CADDY
										STORE_CAR_PLAYER_IS_IN_NO_SAVE player player_car_interiors
										WARP_PLAYER_FROM_CAR_TO_COORD player 27.19 -1327.0 12.0
										DELETE_CAR player_car_interiors
									ENDIF
								ENDIF
								IF IS_PLAYER_IN_ANY_CAR player
								...
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player 27.19 -1327.0 12.0
									SET_PLAYER_HEADING player 23.0
									SET_EXTRA_COLOURS 3 FALSE
									//SET_CAMERA_IN_FRONT_OF_PLAYER
								ELSE
									GOTO interiors_inner
					...
					IF flag_player_in_apartment3c = 1
						IF LOCATE_PLAYER_ANY_MEANS_3D	player 26.73 -1329.8 13.0 1.0 1.0 2.0 FALSE
							IF IS_PLAYER_IN_ANY_CAR player
							AND NOT IS_PLAYER_ON_ANY_BIKE player
								GOTO interiors_inner
							ENDIF
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player 27.33 -1331.1 11.8
								SET_PLAYER_HEADING player 160.0
								SET_CAMERA_IN_FRONT_OF_PLAYER
							ELSE
								GOTO interiors_inner
							ENDIF
		...
		IF IS_PLAYER_PLAYING player
			flag_interiors_cleanup = 0
			IF IS_PLAYER_IN_ZONE player BEACH2
			OR flag_player_on_rc_mission = 1
				IF pooz_counter = 1
					IF flag_player_on_mission = 0
					...
					IF IS_PLAYER_PLAYING player
						...
						OR flag_player_on_colonel1_mission = 1
							IF flag_player_in_cop_shop = 0
								IF IS_PLAYER_IN_REMOTE_MODE player
									...
									ENDIF
								ELSE
									IF IS_PLAYER_IN_ANGLED_AREA_3D player 399.0 -474.5 11.0 394.3 -470.8 14.5 2.5 FALSE
										IF IS_PLAYER_IN_ANY_CAR player
										AND NOT IS_PLAYER_ON_ANY_BIKE player
											GOTO interiors_inner
										ENDIF
										...
										IF IS_PLAYER_PLAYING player
											IF IS_PLAYER_ON_ANY_BIKE player
												STORE_CAR_PLAYER_IS_IN_NO_SAVE player player_car_interiors
												WARP_PLAYER_FROM_CAR_TO_COORD player 393.8 -475.8 11.4
												DELETE_CAR player_car_interiors
											ENDIF
										ENDIF
										IF flag_eject = 0
											...
											SET_PLAYER_COORDINATES player 393.8 -475.8 11.4
											SET_PLAYER_HEADING player 137.0
						...
						IF flag_player_in_cop_shop = 1
							IF IS_PLAYER_IN_ANGLED_AREA_3D player 399.3 -472.9 11.0 394.8 -469.3 14.5 1.5 FALSE
								IF IS_PLAYER_IN_ANY_CAR player
								AND NOT IS_PLAYER_ON_ANY_BIKE player
									GOTO interiors_inner
								ENDIF
								...
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player 399.38 -468.6 10.7
									SET_PLAYER_HEADING player 330.0
									//SET_CAMERA_IN_FRONT_OF_PLAYER
								ELSE
									GOTO interiors_inner
								ENDIF
		...
		IF IS_PLAYER_PLAYING player
			flag_interiors_cleanup = 0
			IF pooz_counter = 1
				IF IS_PLAYER_IN_ZONE player BEACH3
				OR flag_player_on_rc_mission = 1
						...
						IF IS_PLAYER_PLAYING player
							...
							AND flag_player_on_mission = 0
								IF IS_PLAYER_IN_REMOTE_MODE player
									...
									ENDIF
								ELSE
									IF LOCATE_PLAYER_ANY_MEANS_3D player 491.0 -77.7 10.4 1.5 1.5 3.0 FALSE
										IF IS_PLAYER_IN_ANY_CAR player
										AND NOT IS_PLAYER_ON_ANY_BIKE player
											GOTO interiors_inner
										ENDIF
										...
										IF IS_PLAYER_PLAYING player
											...
											OR IS_PLAYER_IN_MODEL player CADDY
												STORE_CAR_PLAYER_IS_IN_NO_SAVE player player_car_interiors
												WARP_PLAYER_FROM_CAR_TO_COORD player 484.2 -72.5 9.5
												DELETE_CAR player_car_interiors
											ENDIF
										ENDIF
										IF flag_eject = 0
											...
											SET_PLAYER_COORDINATES player 484.2 -72.5 9.5
							...
							IF flag_player_in_malibu = 1
								IF LOCATE_PLAYER_ANY_MEANS_3D player 488.6 -75.4 10.4 1.5 1.5 3.0 FALSE
									IF IS_PLAYER_IN_ANY_CAR player
									AND NOT IS_PLAYER_ON_ANY_BIKE player
										GOTO interiors_inner
									ENDIF
									...
									IF flag_eject = 0
										...
										SET_PLAYER_COORDINATES player 493.1  -82.4 9.8
										SET_PLAYER_HEADING player 220.0
										//SET_CAMERA_IN_FRONT_OF_PLAYER
									ELSE
										GOTO interiors_inner
									ENDIF
		...
		IF IS_PLAYER_PLAYING player
			flag_interiors_cleanup = 0
			IF IS_PLAYER_IN_ZONE player HAVANA
			OR flag_player_on_rc_mission = 1
				IF pooz_counter = 2
					IF IS_PLAYER_IN_REMOTE_MODE player
						GET_REMOTE_CONTROLLED_CAR player player_car_interiors
					...
					ELSE
						IF flag_player_in_cafe = 0
							IF LOCATE_PLAYER_ANY_MEANS_3D player -1170.0 -609.0 11.0 1.5 1.5 3.0 FALSE
								IF IS_PLAYER_IN_ANY_CAR player
								AND NOT IS_PLAYER_ON_ANY_BIKE player
									GOTO interiors_inner
								ENDIF
								...
								IF IS_PLAYER_PLAYING player
									IF IS_PLAYER_ON_ANY_BIKE player
										STORE_CAR_PLAYER_IS_IN_NO_SAVE player player_car_interiors
										WARP_PLAYER_FROM_CAR_TO_COORD player -1170.0 -611.0 11.0
										DELETE_CAR player_car_interiors
									ENDIF
								ENDIF
								IF flag_eject = 0
									...
									SWITCH_RUBBISH OFF
									SET_PLAYER_COORDINATES player -1170.0 -611.5 11.0
					...
					IF flag_player_in_cafe = 1
						IF LOCATE_PLAYER_ANY_MEANS_3D player -1170.0 -606.5 11.0 1.5 1.5 3.0 FALSE
							IF IS_PLAYER_IN_ANY_CAR player
							AND NOT IS_PLAYER_ON_ANY_BIKE player
								GOTO interiors_inner
							ENDIF
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player -1170.0 -605.0 11.0
				...
				IF pooz_counter = 2
					IF flag_player_in_mall = 0
						IF IS_PLAYER_IN_REMOTE_MODE player
							...
							ENDIF
						ELSE
							IF LOCATE_PLAYER_ANY_MEANS_3D player 448.8 999.9 18.4 3.5 3.5 3.0 FALSE
								IF IS_PLAYER_IN_ANY_CAR player
								AND NOT IS_PLAYER_ON_ANY_BIKE player
								AND NOT IS_PLAYER_IN_MODEL player CADDY
									GOTO interiors_inner
								...
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player 448.3 1006.0 18.0
									float_heading = 0.0
					...
					IF flag_player_in_mall = 1
						IF LOCATE_PLAYER_ANY_MEANS_3D player 448.8 999.9 18.4 3.5 3.5 3.0 FALSE
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player 449.7 992.2 17.0
								float_heading = 180.0
								GOSUB vehicle_heading
								//SET_PLAYER_HEADING player 180.0
								//SET_CAMERA_IN_FRONT_OF_PLAYER
				...
				IF pooz_counter = 1
					IF flag_player_in_mall = 0
						IF IS_PLAYER_IN_REMOTE_MODE player
							...
							ENDIF
						ELSE
							IF LOCATE_PLAYER_ANY_MEANS_3D player 380.1 999.0 19.4 3.5 3.5 3.0 FALSE
								IF IS_PLAYER_IN_ANY_CAR player
								AND NOT IS_PLAYER_ON_ANY_BIKE player
								AND NOT IS_PLAYER_IN_MODEL player CADDY
									GOTO interiors_inner
								...
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player 380.0 1006.4 18.2
									float_heading = 0.0
									GOSUB vehicle_heading
									//SET_PLAYER_HEADING player 0.0
									SET_EXTRA_COLOURS 6 FALSE
					...
					IF flag_player_in_mall = 1
						IF LOCATE_PLAYER_ANY_MEANS_3D	player 380.1 999.0 19.4 3.5 3.5 3.0 FALSE
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player 379.3 991.4 17.0
								float_heading = 180.0
								GOSUB vehicle_heading
								//SET_PLAYER_HEADING player 180.0
								//SET_CAMERA_IN_FRONT_OF_PLAYER
				...
				IF pooz_counter = 1
					IF flag_player_in_mall = 0
						IF IS_PLAYER_IN_REMOTE_MODE player
							...
							ENDIF
						ELSE
							IF LOCATE_PLAYER_ANY_MEANS_3D player 353.3 1124.5 19.4 3.2 3.2 3.0 FALSE
								IF IS_PLAYER_IN_ANY_CAR player
								AND NOT IS_PLAYER_ON_ANY_BIKE player
								AND NOT IS_PLAYER_IN_MODEL player CADDY
									GOTO interiors_inner
								...
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player 363.0 1124.4 17.5
									float_heading = 270.0
									GOSUB vehicle_heading
									//SET_PLAYER_HEADING player 270.0
									SET_EXTRA_COLOURS 6 FALSE
					...
					IF flag_player_in_mall = 1
						IF LOCATE_PLAYER_ANY_MEANS_3D player 353.3 1124.5 19.4 3.2 3.2 3.0 FALSE
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player 344.5 1123.5 17.0
								float_heading = 90.0
								GOSUB vehicle_heading
				...
				IF pooz_counter = 2
					IF flag_player_in_mall = 0
						IF IS_PLAYER_IN_REMOTE_MODE player
							...
							ENDIF
						ELSE
							IF LOCATE_PLAYER_ANY_MEANS_3D player 367.8 1210.3 26.0 2.7 2.7 3.0 FALSE
								IF IS_PLAYER_IN_ANY_CAR player
								AND NOT IS_PLAYER_ON_ANY_BIKE player
								AND NOT IS_PLAYER_IN_MODEL player CADDY
									GOTO interiors_inner
								...
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player 372.0 1210.0 24.4
									float_heading = 270.0
									GOSUB vehicle_heading
									//SET_PLAYER_HEADING player 270.0
									SET_EXTRA_COLOURS 6 FALSE
					...
					IF flag_player_in_mall = 1
						IF LOCATE_PLAYER_ANY_MEANS_3D player 367.8 1210.3 26.0 2.7 2.70 3.0 FALSE
							IF IS_PLAYER_IN_ANY_CAR player
							AND NOT IS_PLAYER_ON_ANY_BIKE player
							AND NOT IS_PLAYER_IN_MODEL player CADDY
								GOTO interiors_inner
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player 364.0 1210.0 24.0
								float_heading = 90.0
								GOSUB vehicle_heading
								//SET_PLAYER_HEADING player 90.0
								//SET_CAMERA_IN_FRONT_OF_PLAYER
				...
				IF pooz_counter = 2
					IF flag_player_in_mall = 0
						IF IS_PLAYER_IN_REMOTE_MODE player
							...
							ENDIF
						ELSE
							IF LOCATE_PLAYER_ANY_MEANS_3D player 380.6 1253.5 17.5 3.5 3.5 3.0 FALSE
								IF IS_PLAYER_IN_ANY_CAR player
								AND NOT IS_PLAYER_ON_ANY_BIKE player
								AND NOT IS_PLAYER_IN_MODEL player CADDY
									GOTO interiors_inner
								...
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player 380.0 1246.7 18.0
									float_heading = 180.0
									GOSUB vehicle_heading
									//SET_PLAYER_HEADING player 180.0
									SET_EXTRA_COLOURS 6 FALSE
					...
					IF flag_player_in_mall = 1
						IF LOCATE_PLAYER_ANY_MEANS_3D player 380.6 1253.5 17.5 3.5 3.5 3.0 FALSE
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player 378.0 1263.6 16.5
								float_heading = 0.0
								GOSUB vehicle_heading
								//SET_PLAYER_HEADING player 0.0
								//SET_CAMERA_IN_FRONT_OF_PLAYER
				...
				IF pooz_counter = 1
					IF flag_player_in_mall = 0
						IF IS_PLAYER_IN_REMOTE_MODE player
							...
							ENDIF
						ELSE
							IF LOCATE_PLAYER_ANY_MEANS_3D player 448.0 1253.0 19.2 3.0 3.0 3.0 FALSE
								IF IS_PLAYER_IN_ANY_CAR player
								AND NOT IS_PLAYER_ON_ANY_BIKE player
								AND NOT IS_PLAYER_IN_MODEL player CADDY
									GOTO interiors_inner
								...
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player 448.5 1245.0 18.0
									float_heading = 180.0
									GOSUB vehicle_heading
									//SET_PLAYER_HEADING player 180.0
									SET_EXTRA_COLOURS 6 FALSE
					...
					IF flag_player_in_mall = 1
						IF LOCATE_PLAYER_ANY_MEANS_3D player 448.0 1253.0 19.2 3.0 3.0 3.0 FALSE
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player 449.0 1263.0 16.5
								float_heading = 0.0
								GOSUB vehicle_heading
								//SET_PLAYER_HEADING player 0.0
								//SET_CAMERA_IN_FRONT_OF_PLAYER
				...
				IF pooz_counter = 2
					IF flag_player_in_mall = 0
						IF IS_PLAYER_IN_REMOTE_MODE player
							...
							ENDIF
						ELSE
							IF LOCATE_PLAYER_ANY_MEANS_3D player 474.5 1124.0 19.3 3.5 3.5 3.0 FALSE
								IF IS_PLAYER_IN_ANY_CAR player
								AND NOT IS_PLAYER_ON_ANY_BIKE player
								AND NOT IS_PLAYER_IN_MODEL player CADDY
									GOTO interiors_inner
								...
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player 467.4 1123.7 17.0
									float_heading = 90.0
									GOSUB vehicle_heading
									//SET_PLAYER_HEADING player 90.0
									SET_EXTRA_COLOURS 6 FALSE
					...
					IF flag_player_in_mall = 1
						IF LOCATE_PLAYER_ANY_MEANS_3D player 474.5 1124.0 19.3 3.5 3.5 3.0 FALSE
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player 482.0 1124.5 15.3
								float_heading = 0.0
								GOSUB vehicle_heading
								//SET_PLAYER_HEADING player 0.0
								//SET_CAMERA_IN_FRONT_OF_PLAYER
		...
		IF IS_PLAYER_PLAYING player
			flag_interiors_cleanup = 0
			IF IS_PLAYER_IN_ZONE player DTOWN
			OR flag_player_on_rc_mission = 1
				IF pooz_counter = 1
					IF flag_player_in_shooting_range = 0
						...
						ELSE
							...
							IF LOCATE_PLAYER_ANY_MEANS_3D player -667.85 1211.9 11.0 1.5 1.5 3.0 FALSE
								PRINT_BIG ( RANGE ) 3000 2 //"The Malibu1"
								GOSUB transition_1
								IF IS_PLAYER_PLAYING player
									IF IS_PLAYER_ON_ANY_BIKE player
										STORE_CAR_PLAYER_IS_IN_NO_SAVE player player_car_interiors
										WARP_PLAYER_FROM_CAR_TO_COORD player -667.8 1221.0 10.5
										DELETE_CAR player_car_interiors
									ENDIF
								ENDIF
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player -667.8 1221.0 10.3
									SET_PLAYER_HEADING player 0.0
					...
					IF flag_player_in_shooting_range = 1
						IF LOCATE_PLAYER_ANY_MEANS_3D player -667.8 1217.8 11.0 1.5 1.5 3.0 FALSE
							//IF IS_PLAYER_IN_ANY_CAR player
							//AND NOT IS_PLAYER_ON_ANY_BIKE player
								//GOTO interiors_inner
							//ENDIF
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player -667.8 1210.0 10.3
		...
		IF IS_PLAYER_PLAYING player
			flag_interiors_cleanup = 0
			IF IS_PLAYER_IN_ZONE player STARI
			OR flag_player_on_rc_mission = 1
						...
						IF pooz_counter = 1
							IF flag_player_in_mansion = 0
								IF IS_PLAYER_IN_REMOTE_MODE player
									...
									ENDIF
								ELSE
									IF IS_PLAYER_IN_AREA_3D player -382.0 -558.5 18.537 -375.0 -554.5 24.537 FALSE
										...
										IF IS_PLAYER_PLAYING player
											...
											AND NOT IS_PLAYER_IN_MODEL player CADDY
												STORE_CAR_PLAYER_IS_IN_NO_SAVE player player_car_interiors
												WARP_PLAYER_FROM_CAR_TO_COORD player -378.5 -560.0 19.0
												DELETE_CAR player_car_interiors
											ENDIF
										ENDIF
										*/
										IF flag_eject = 0
											...
											SET_PLAYER_COORDINATES player -378.5 -560.0 19.0
											float_heading = 190.0
											GOSUB vehicle_heading
											//SET_PLAYER_HEADING player 190.0
							...
							IF flag_player_in_mansion = 1
								IF IS_PLAYER_IN_AREA_3D player -382.0 -554.5 18.537 -375.0 -550.5 24.537 FALSE	
									...
									IF flag_eject = 0
										...
										SET_PLAYER_COORDINATES player -377.06 -545.43 16.0
										SET_PLAYER_HEADING player 345.0
										//SET_CAMERA_IN_FRONT_OF_PLAYER
									ELSE
										GOTO interiors_inner
									ENDIF
					...
					IF pooz_counter = 2
						IF flag_player_in_mansion = 0
							IF IS_PLAYER_IN_REMOTE_MODE player
								...
								ENDIF
							ELSE
								//IF IS_PLAYER_IN_AREA_3D	player -336.902 -577.589 34.52 -331.269 -569.893 38.113 FALSE
								IF IS_PLAYER_IN_AREA_3D	player -340.402 -579.221 34.52 -331.269 -568.389 38.113 FALSE
									...
									IF IS_PLAYER_PLAYING player
										IF IS_PLAYER_ON_ANY_BIKE player
											STORE_CAR_PLAYER_IS_IN_NO_SAVE player player_car_interiors
											WARP_PLAYER_FROM_CAR_TO_COORD player -329.24 -582.5 34.5
											DELETE_CAR player_car_interiors
										ENDIF
									ENDIF
									IF flag_eject = 0
										...
										SET_PLAYER_COORDINATES player -329.24 -582.5 34.5
										SET_PLAYER_HEADING player 270.0
										SET_EXTRA_COLOURS 8 FALSE
										//SET_CAMERA_IN_FRONT_OF_PLAYER
									ELSE
						...
						IF flag_player_in_mansion = 1
							IF LOCATE_PLAYER_ANY_MEANS_3D player -330.1 -578.9 34.5 2.0 2.0 3.0 FALSE
								PRINT_BIG ( STARI ) 3000 2
								GOSUB transition_1
								IF flag_eject = 0
									GOSUB outgoing
									...
									//SET_PLAYER_COORDINATES player -338.738 -573.984 35.305
									SET_PLAYER_COORDINATES player -341.738 -573.984 35.305
					...
					IF pooz_counter = 1
						IF flag_player_in_mansion = 0
							IF IS_PLAYER_IN_REMOTE_MODE player
								...
								ENDIF
							ELSE
								IF LOCATE_PLAYER_ANY_MEANS_3D	player -354.0 -580.6 11.0 1.5 1.5 3.0 FALSE
									...
									IF IS_PLAYER_PLAYING player
										...
										OR IS_PLAYER_IN_MODEL player CADDY
											STORE_CAR_PLAYER_IS_IN_NO_SAVE player player_car_interiors
											WARP_PLAYER_FROM_CAR_TO_COORD player -338.5 -578.8 10.6
											DELETE_CAR player_car_interiors
										ENDIF
									ENDIF
									*/
									IF flag_eject = 0
										...
										SET_PLAYER_COORDINATES player -338.5 -578.8 10.6
										float_heading = 270.0
										GOSUB vehicle_heading
										//SET_PLAYER_HEADING player 270.0
										SET_EXTRA_COLOURS 8 FALSE
						...
						IF flag_player_in_mansion = 1
							IF LOCATE_PLAYER_ANY_MEANS_3D	player -346.3 -578.8 10.6 1.5 1.5 3.0 FALSE
								PRINT_BIG ( STARI ) 3000 2 
								GOSUB transition_1
								IF flag_eject = 0
									GOSUB outgoing
									...
									SET_PLAYER_COORDINATES player -354.0 -586.0 10.6
									float_heading = 180.0
									GOSUB vehicle_heading
									//SET_PLAYER_HEADING player 180.0
									//SET_CAMERA_IN_FRONT_OF_PLAYER
				...
				OR flag_player_on_rc_mission = 1
					IF pooz_counter = 2
						...
						IF IS_PLAYER_IN_REMOTE_MODE player
							...
							ENDIF
						ELSE
							IF LOCATE_PLAYER_ANY_MEANS_3D	player -896.5 -341.0 13.4 1.4 1.4 3.0 FALSE
								IF IS_PLAYER_IN_ANY_CAR player
								AND NOT IS_PLAYER_ON_ANY_BIKE player
								AND NOT IS_PLAYER_IN_MODEL player CADDY
									GOTO interiors_inner
								...
								IF IS_PLAYER_PLAYING player
									...
									OR IS_PLAYER_IN_MODEL player CADDY
										STORE_CAR_PLAYER_IS_IN_NO_SAVE player player_car_interiors
										WARP_PLAYER_FROM_CAR_TO_COORD player -903.0 -341.0 12.5
										DELETE_CAR player_car_interiors
									ENDIF
								ENDIF
								IF flag_eject = 0
									...
									SET_PLAYER_COORDINATES player -903.0 -341.0 12.5
						...
						IF LOCATE_PLAYER_ANY_MEANS_3D	player -900.0 -340.9 13.4 1.5 1.5 3.0 FALSE
							IF IS_PLAYER_IN_ANY_CAR player
							AND NOT IS_PLAYER_ON_ANY_BIKE player
								GOTO interiors_inner
							ENDIF
							...
							IF flag_eject = 0
								...
								SET_PLAYER_COORDINATES player -893.0 -341.0 12.0
								flag_player_in_bank = 0
								SET_PLAYER_HEADING player 270.0
								SET_CAMERA_IN_FRONT_OF_PLAYER
							ELSE
...
IF IS_PLAYER_PLAYING player
	...
	//STORE_WANTED_LEVEL player wanted_interior
...
populate_strip:
	...
	IF flag_player_in_stripclub = 1
		IF flag_strip_populate = 1
			...
			IF IS_PLAYER_PLAYING player
			AND IS_SCORE_GREATER player 5
			AND flag_player_on_mission = 0  
				IF LOCATE_PLAYER_ON_FOOT_2D player 69.3 -1455.9 1.0 1.0 TRUE
				AND CAN_PLAYER_START_MISSION player
			...
			AND flag_player_on_mission = 0  
				IF LOCATE_PLAYER_ON_FOOT_2D player 70.0 -1443.64 1.0 1.0 TRUE
				AND CAN_PLAYER_START_MISSION player
					MAKE_PLAYER_SAFE_FOR_CUTSCENE player
...
IF NOT IS_CHAR_DEAD ped_rumble
	...
	IF IS_PLAYER_PLAYING player
		SET_CHAR_OBJ_KILL_PLAYER_ON_FOOT ped_rumble player
	ENDIF
	//TURN_CHAR_TO_FACE_PLAYER ped_rumble player
	//SET_CHAR_THREAT_SEARCH ped_rumble THREAT_player
ENDIF
RETURN
...
IF IS_PLAYER_PLAYING player
	...
	IF NOT IS_CHAR_DEAD scplayer
		...
		//CHAR_LOOK_AT_CHAR_ALWAYS player dancer_4
	ENDIF
	counter_strip_cam = 0
	...
	timera = 5000 
	WHILE IS_SCORE_GREATER player 5
		WAIT 0
		//GOSUB waitstate_every_frame
		IF NOT IS_PLAYER_PLAYING player
			RETURN
	...
	IF IS_PLAYER_PLAYING player
		...
		SET_PLAYER_COORDINATES player 72.0 -1454.7 9.45
		SET_PLAYER_HEADING player 208.0
	ENDIF
	CLEAR_PRINTS
...
the_groovier_room:
	...
	IF IS_PLAYER_PLAYING player
		SET_PLAYER_COORDINATES player 66.5 -1445.5 9.6
		SET_PLAYER_HEADING player 220.0
	ENDIF
...
//					ELSE
//						IF NOT IS_CHAR_DEAD bouncer_1
//							SET_PLAYER_AS_LEADER bouncer_1 player
//						ENDIF
//						IF NOT IS_CHAR_DEAD bouncer_2
//							SET_PLAYER_AS_LEADER bouncer_2 player
//						ENDIF
//						IF NOT IS_CHAR_DEAD bouncer_3
//							SET_PLAYER_AS_LEADER bouncer_3 player
//						ENDIF
//						IF NOT IS_CHAR_DEAD bouncer_4
//							SET_PLAYER_AS_LEADER bouncer_4 player
//						ENDIF
					ENDIF
				ENDIF
				...
				AND NOT IS_CHAR_DEAD bar_staff1
					IF LOCATE_PLAYER_ON_FOOT_3D player 462.7 -57.3 11.5 1.5 1.5 2.0 FALSE
						...
						AND IS_PLAYER_PLAYING player
							...
							SET_CHAR_OBJ_KILL_PLAYER_ON_FOOT bar_staff1 player
						ENDIF
						GOSUB attack_the_bastard
...
IF IS_PLAYER_PLAYING player
	IF NOT IS_CHAR_DEAD bouncer_1
		SET_CHAR_OBJ_KILL_PLAYER_ON_FOOT bouncer_1 player
	ENDIF
	IF NOT IS_CHAR_DEAD bouncer_2
		SET_CHAR_OBJ_KILL_PLAYER_ON_FOOT bouncer_2 player
	ENDIF
	IF NOT IS_CHAR_DEAD bouncer_3
		SET_CHAR_OBJ_KILL_PLAYER_ON_FOOT bouncer_3 player
	ENDIF
	IF NOT IS_CHAR_DEAD bouncer_4
		SET_CHAR_OBJ_KILL_PLAYER_ON_FOOT bouncer_4 player
	ENDIF
ENDIF
RETURN
...
IF IS_PLAYER_PLAYING player
	...
	ELSE
		SET_PLAYER_HEADING player float_heading
	ENDIF
ENDIF
RETURN
